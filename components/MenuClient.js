  ...
  return (
    ...
    >
      <motion.div
        ...
        className="h-96 md:h-[33rem] w-full md:w-[38rem] relative overflow-hidden rounded-3xl shadow-lg"
      >
      ...
      <motion.div
        ...
        className="w-full md:w-[60%] p-6 md:p-10 bg-[#fff5e0] rounded-3xl shadow-md"
      >
...
export default function MenuClient({ menuCategories, reviewSummary }) {
  ...
  return (
    <div id="menu" className="w-full max-w-6xl mx-auto py-10 space-y-10 px-4">
